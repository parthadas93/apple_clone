        ...
        <>
         <div className="modelImage">
            ...
            <div className="desktopgridContainer">
                ...
                <div className="gridItem">
              <img src="https://www.apple.com/v/mac/home/bl/images/overview/compare/compare_icon_m1_pro_max__d1toavnfl1m6_large.png" alt="" />
                    <h5>Apple M1 Pro chip or Apple M1 Max chip</h5></div>
                <div className="gridItem">
                ...
                <h3>8-Core</h3>
                    <h5>GPU</h5> </div>
                <div className="gridItem">Up-to
                <h3>32-Core</h3>
                    <h5>GPU</h5></div>
                <div className="gridItem">
                    <img src="https://www.apple.com/v/mac/home/bl/images/overview/compare/compare_icon_unified_memory__emykppauav2a_large.png" alt="" />
                ...
                <div className="gridItem">
                <h3>2-TB</h3>
                    <h5>Maximum configurable storage1</h5> </div>
                    <div className="gridItem">
                <h3>2-TB</h3>
                    <h5>Maximum configurable storage1</h5> </div>
                    <div className="gridItem">
